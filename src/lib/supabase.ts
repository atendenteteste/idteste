...
export function getAvailableProductComponents() {
  ...
  const passportGuideComponent = {
    ...
    elements: [
      { id: 'title', type: 'text', name: 'Título Principal' },
      { id: 'intro_paragraph', type: 'text', name: 'Parágrafo de Introdução' },
      { id: 'article_info', type: 'text', name: 'Informação do Artigo' },
      { id: 'bullet_1', type: 'text', name: 'Item 1 da Lista de Introdução' },
      { id: 'bullet_2', type: 'text', name: 'Item 2 da Lista de Introdução' },
      { id: 'bullet_3', type: 'text', name: 'Item 3 da Lista de Introdução' },
      { id: 'bullet_4', type: 'text', name: 'Item 4 da Lista de Introdução' },
      
      { id: 'passport_title', type: 'text', name: 'Título: Fotos para o Passaporte' },
      { id: 'passport_paragraph_1', type: 'text', name: 'Parágrafo 1: Fotos para o Passaporte' },
      { id: 'passport_paragraph_2', type: 'text', name: 'Parágrafo 2: Fotos para o Passaporte' },
      
      { id: 'visa_title', type: 'text', name: 'Título: Fotos para o Visto' },
      { id: 'visa_paragraph', type: 'text', name: 'Parágrafo: Fotos para o Visto' },
      
      { id: 'cnh_title', type: 'text', name: 'Título: Fotos para a CNH' },
      { id: 'cnh_paragraph', type: 'text', name: 'Parágrafo: Fotos para a CNH' },
      
      { id: 'rg_title', type: 'text', name: 'Título: Fotos para o RG' },
      { id: 'rg_paragraph', type: 'text', name: 'Parágrafo: Fotos para o RG' },
      
      { id: 'perfect_photo_title', type: 'text', name: 'Título: Como Tirar Foto Perfeita' },
      { id: 'perfect_photo_intro', type: 'text', name: 'Introdução: Como Tirar Foto Perfeita' },
      
      { id: 'step_1', type: 'text', name: 'Passo 1: Como Tirar Foto' },
      { id: 'step_2', type: 'text', name: 'Passo 2: Como Tirar Foto' },
      { id: 'step_3', type: 'text', name: 'Passo 3: Como Tirar Foto' },
      { id: 'step_4', type: 'text', name: 'Passo 4: Como Tirar Foto' },
      
      { id: 'clothes_title', type: 'text', name: 'Título: Que Tipo de Roupa Usar' },
      { id: 'clothes_paragraph', type: 'text', name: 'Parágrafo: Que Tipo de Roupa Usar' },
      
      { id: 'errors_title', type: 'text', name: 'Título: Erros Comuns' },
      { id: 'errors_intro', type: 'text', name: 'Introdução: Erros Comuns' },
      
      { id: 'error_1_title', type: 'text', name: 'Título Erro 1' },
      { id: 'error_1_description', type: 'text', name: 'Descrição Erro 1' },
      { id: 'error_2_title', type: 'text', name: 'Título Erro 2' },
      { id: 'error_2_description', type: 'text', name: 'Descrição Erro 2' },
      { id: 'error_3_title', type: 'text', name: 'Título Erro 3' },
      { id: 'error_3_description', type: 'text', name: 'Descrição Erro 3' },
      { id: 'error_4_title', type: 'text', name: 'Título Erro 4' },
      { id: 'error_4_description', type: 'text', name: 'Descrição Erro 4' },
      { id: 'error_5_title', type: 'text', name: 'Título Erro 5' },
      { id: 'error_5_description', type: 'text', name: 'Descrição Erro 5' },
      
      { id: 'tool_title', type: 'text', name: 'Título: Ferramenta de Foto' },
      { id: 'tool_paragraph', type: 'text', name: 'Parágrafo: Ferramenta de Foto' },
      
      { id: 'tool_feature_1', type: 'text', name: 'Recurso 1 da Ferramenta' },
      { id: 'tool_feature_2', type: 'text', name: 'Recurso 2 da Ferramenta' },
      { id: 'tool_feature_3', type: 'text', name: 'Recurso 3 da Ferramenta' },
      { id: 'tool_feature_4', type: 'text', name: 'Recurso 4 da Ferramenta' },
      
      { id: 'iphone_title', type: 'text', name: 'Título: App para iPhone' },
      { id: 'iphone_paragraph', type: 'text', name: 'Parágrafo: App para iPhone' },
      
      { id: 'android_title', type: 'text', name: 'Título: App para Android' },
      { id: 'android_paragraph', type: 'text', name: 'Parágrafo: App para Android' },
      
      { id: 'reasons_title', type: 'text', name: 'Título: 5 Razões' },
      { id: 'reasons_intro', type: 'text', name: 'Introdução: 5 Razões' },
      
      { id: 'reason_1_title', type: 'text', name: 'Título Razão 1' },
      { id: 'reason_1_description', type: 'text', name: 'Descrição Razão 1' },
      { id: 'reason_2_title', type: 'text', name: 'Título Razão 2' },
      { id: 'reason_2_description', type: 'text', name: 'Descrição Razão 2' },
      { id: 'reason_3_title', type: 'text', name: 'Título Razão 3' },
      { id: 'reason_3_description', type: 'text', name: 'Descrição Razão 3' },
      { id: 'reason_4_title', type: 'text', name: 'Título Razão 4' },
      { id: 'reason_4_description', type: 'text', name: 'Descrição Razão 4' },
      { id: 'reason_5_title', type: 'text', name: 'Título Razão 5' },
      { id: 'reason_5_description', type: 'text', name: 'Descrição Razão 5' }
    ]
  };
